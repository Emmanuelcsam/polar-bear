...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="OmniFiberAnalyzer - Fiber Optic Defect Detection System",
    ...
    parser.add_argument(
        'image_path',
        nargs='?',
        help='Path to fiber image for analysis'
    )
    ...
    if args.image_path:
        ...
        output_dir = args.output or os.path.dirname(args.image_path)
        
        try:
            report = analyzer.analyze_end_face(args.image_path, output_dir)
        ...
        parser.print_help()
        print("\nExample usage:")
        print("  python detection.py image.png --output results/")
        print("  python detection.py image.png --kb knowledge_base.json")
