...
NORMAL_IMAGES_DIR = r"C:\path\to\your\normal_images_folder" # Directory of images to learn from
ANOMALY_MAP_PATH  = r"live_anomaly_map.png"                 # Where to save the output map on detection
