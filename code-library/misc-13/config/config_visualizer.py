...
class EquationVisualizationWidget(QWidget):
    ...
    def update_equation_visualization(self, coefficients=None):
        ...
        components = {
            'xâ‚': 'Reference Similarity',
            'xâ‚‚': 'Trend Adherence',
            'xâ‚ƒ': 'Inverse Anomaly Score',
            'xâ‚„': 'Segmentation Confidence',
            'xâ‚…': 'Reconstruction Quality'
        }
...
class SignalVisualizationWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.animate_btn = QPushButton("â–¶ï¸ Start Animation")
        ...
        self.reset_btn = QPushButton("ðŸ”„ Reset View")
    ...
    def toggle_animation(self):
        ...
        if self.timer.isActive():
            self.timer.stop()
            self.animate_btn.setText("â–¶ï¸ Start Animation")
        else:
            self.timer.start(50)  # 20 FPS
            self.animate_btn.setText("â¸ï¸ Stop Animation")
...
class ConfigVisualizerMainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        title = QLabel("âš™ï¸ Configuration Parameters")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        right_panel.addTab(self.signal_widget, "ðŸ“Š Signal Analysis")

        # Add system architecture tab
        self.architecture_widget = SystemArchitectureWidget()
        right_panel.addTab(self.architecture_widget, "ðŸ”§ System Architecture")

        # Add equation visualization tab
        self.equation_widget = EquationVisualizationWidget()
        right_panel.addTab(self.equation_widget, "ðŸ“ Equation I=Ax1+Bx2+...")

        # Add performance metrics tab
        self.metrics_widget = PerformanceMetricsWidget()
        right_panel.addTab(self.metrics_widget, "ðŸ“ˆ Performance Metrics")
