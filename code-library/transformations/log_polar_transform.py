...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if img is not None:
            ...
            cv2.imwrite(f"log_polar_transform_output.png", result)
            print(f"Saved to log_polar_transform_output.png")
        else:
            print("Failed to load image")
    else:
        print(f"Usage: python log_polar_transform.py <image_path>")
