...
Combines manual circle overlay, automatic detection, and visual display
"""
...
class UnifiedCoreDetector:
    """Unified core detection with manual overlay and automatic detection"""
    ...
    def __init__(self, config_file: str = "config.json"):
        ...
        # Display settings
        self.window_name = "Unified Core Detection System"
    ...
    def setup(self) -> bool:
        ...
        print("=== SETTING UP UNIFIED CORE DETECTOR ===")
        ...
        print("✓ Unified core detector setup complete")
        return True
    ...
    def run(self):
        """Main run loop"""
        print("=== STARTING UNIFIED CORE DETECTOR ===")
        print("Controls:")
        ...
        try:
            ...
            print(f"Error in unified detector: {e}")
            import traceback
            traceback.print_exc()
        finally:
            self.cleanup()
