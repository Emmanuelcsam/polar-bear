#!/usr/bin/env python3
"""
Hivemind Connector for: training/reference/fc/91/ferrule/oil
Connector ID: 19213402
Depth Level: 6
"""
...
class HivemindConnector:
    def __init__(self):
        self.connector_id = "19213402"
        self.directory = Path("/home/jarvis/Documents/GitHub/polar-bear/training/reference/fc/91/ferrule/oil")
        self.port = 10282
