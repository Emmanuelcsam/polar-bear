#!/usr/bin/env python3
"""
Hivemind Connector for: training/data-gen-cpu/dupe/test_detection_output
Connector ID: f3e20ed2
Depth Level: 4
"""
...
class HivemindConnector:
    def __init__(self):
        self.connector_id = "f3e20ed2"
        self.directory = Path("/home/jarvis/Documents/GitHub/polar-bear/training/data-gen-cpu/dupe/test_detection_output")
        self.port = 10227
        self.parent_port = 10218
        self.depth = 4
        self.running = True
        self.socket = None
