#!/usr/bin/env python3
"""
Hivemind Connector for: training/data-gen-cpu/dupe/test_data_acq
Connector ID: 0b60e898
Depth Level: 4
"""
...
class HivemindConnector:
    def __init__(self):
        self.connector_id = "0b60e898"
        self.directory = Path("/home/jarvis/Documents/GitHub/polar-bear/training/data-gen-cpu/dupe/test_data_acq")
        self.port = 10219
