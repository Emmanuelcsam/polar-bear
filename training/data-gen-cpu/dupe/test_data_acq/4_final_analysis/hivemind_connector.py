#!/usr/bin/env python3
"""
Hivemind Connector for: training/data-gen-cpu/dupe/test_data_acq/4_final_analysis
Connector ID: 824ef571
Depth Level: 5
"""
...
class HivemindConnector:
    def __init__(self):
        self.connector_id = "824ef571"
        self.directory = Path("/home/jarvis/Documents/GitHub/polar-bear/training/data-gen-cpu/dupe/test_data_acq/4_final_analysis")
        self.port = 10220
        self.parent_port = 10219
        self.depth = 5
        self.running = True
        self.socket = None
