#!/usr/bin/env python3
"""
Hivemind Connector for: training/reference/sma/ferrule/dig
Connector ID: e3590d70
Depth Level: 5
"""
...
class HivemindConnector:
    def __init__(self):
        self.connector_id = "e3590d70"
        self.directory = Path("/home/jarvis/Documents/GitHub/polar-bear/training/reference/sma/ferrule/dig")
        self.port = 10249
