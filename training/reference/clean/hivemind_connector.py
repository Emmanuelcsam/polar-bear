#!/usr/bin/env python3
"""
Hivemind Connector for: training/reference/clean
Connector ID: 5951263a
Depth Level: 3
"""
...
class HivemindConnector:
    def __init__(self):
        self.connector_id = "5951263a"
        self.directory = Path("/home/jarvis/Documents/GitHub/polar-bear/training/reference/clean")
        self.port = 10309
