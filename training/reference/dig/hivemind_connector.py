#!/usr/bin/env python3
"""
Hivemind Connector for: training/reference/dig
Connector ID: 8b821604
Depth Level: 3
"""
...
class HivemindConnector:
    def __init__(self):
        self.connector_id = "8b821604"
        self.directory = Path("/home/jarvis/Documents/GitHub/polar-bear/training/reference/dig")
        self.port = 10311
