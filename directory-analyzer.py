...
class EnhancedDirectoryAnalyzer:
    ...
    def build_file_relationship_graph(self):
        ...
        for file_info in self.files_data:
            ...
            # Same directory relationships (weak connection)
            for other_file in self.files_data:
                if (other_file['path'] != file_info['path'] and 
                    Path(other_file['path']).parent == filepath.parent):
                    self.file_graph.add_edge(file_info['path'], other_file['path'], 
    ...
    def analyze_file(self, filepath):
        ...
        try:
            ...
            if file_info['size'] < 104857600:  # 100MB
