...
from architectures import FiberOpticsBackbone, SEBlock
    ...
    def prune_model(self, 
        ...
        if structured:
            ...
            if importance_scores:
                ...
                # Standard global magnitude pruning
        ...
        self.logger.info(f"Pruning complete. Actual sparsity: {actual_sparsity:.1%}")
