...
class LearnedPerceptualSimilarity(nn.Module):
    ...
    def __init__(self, 
        ...
        """
        Args:
            net_type: Network architecture ('vgg16', 'vgg19', 'alex', 'squeeze')
            use_dropout: Whether to use dropout in linear layers
            spatial: Return spatial similarity map
            reduce_mean: Whether to reduce mean over spatial dimensions
        """
        super().__init__()
