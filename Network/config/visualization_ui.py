...
class NeuralNetworkVisualizer(Gtk.Window):
    ...
    def _process_image(self, image: np.ndarray) -> Dict[str, Any]:
        ...
        # Added start_time to measure actual computation time, as 'computation_time' was previously hardcoded to 0 in stats,
        # leading to inaccurate statistics display in the UI. This ensures the computation_time reflects real processing duration.
        start_time = time.time()
