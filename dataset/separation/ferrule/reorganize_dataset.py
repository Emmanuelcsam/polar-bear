...
class_mappings = {
    'scratch': ['scratch'],
    'clean': ['ubet'],
    'contaminated': ['_core', 'img (', 'core.png', 'core_51.png'],
    'masks': ['mask', 'Davids_circle', 'circle_split', 'white_region']
}
...
metadata = {
    ...
    'classes': {
        'scratch': {'description': 'Fiber cores with scratch defects', 'label': 0},
        'clean': {'description': 'Clean fiber cores with minimal defects', 'label': 1},
        'contaminated': {'description': 'Fiber cores with contamination or other defects', 'label': 2},
        'masks': {'description': 'Binary masks for processing (excluded from training)', 'label': -1}
    },
    'images': []
}
