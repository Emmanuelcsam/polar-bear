...
def validate_imports():
    ...
    modules_to_check = [
        # Main modules
        ('integrated_geometry_system', 'Main geometry system'),
        ('performance_benchmark_tool', 'Performance benchmarking'),
        ('realtime_calibration_tool', 'Calibration tool'),
        ('example_application', 'Example application'),
        ('setup_installer', 'Setup installer'),
        ('uv_compatible_setup', 'UV setup helper'),
        ('python313_fix', 'Python 3.13 fix'),
        
        # Test modules
        ('test_integrated_geometry_system', 'Tests for main system'),
        ('test_performance_benchmark_tool', 'Tests for benchmarking'),
        ('test_realtime_calibration_tool', 'Tests for calibration'),
        ('test_example_application', 'Tests for example app'),
        ('test_setup_installer', 'Tests for installer'),
        ('test_uv_compatible_setup', 'Tests for UV setup'),
        ('test_python313_fix', 'Tests for Python 3.13 fix'),
    ]
