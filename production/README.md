...
- **GUI**: Works with or without display
...
- With PylonViewer analyze a good fiber and save the image as good.bmp
...
### Camera (`camera/`)
- **pylon_grabber.py**: Threaded frame grabber for Basler cameras
