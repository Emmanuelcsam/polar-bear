...
def adaptive_segment_image(image_path, peak_prominence=500, output_dir="adaptive_segmented_regions"):
    ...
    try:
        ...
        for i, (min_val, max_val) in enumerate(intensity_ranges):
            ...
            # FIXED: Ensure all values are integers for cv2.inRange
            min_val = int(min_val)
            max_val = int(max_val)
            ...
            if contours:
                ...
                regions_info.append({
                    ...
                    'peak_intensity': int(peak_intensity),  # FIXED: Ensure integer
                ...
                output_filename = f"{base_filename}_adaptive_region_{i+1}_intensity_{int(peak_intensity)}.png"
